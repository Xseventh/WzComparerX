# 2026-04-28 IMG Convex Inspection

## Summary

- Added IMG object-value inspection for `Shape2D#Convex2D`.
- Reused the existing Vector inspection model for Convex points.
...
- WC requires Convex2D entries to contain only Vector2D objects; WCX now keeps
  that validation in the inspection reader.
