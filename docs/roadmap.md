...
| Package parsing | PKG1, PKG2, Base/extension packages, `.ms`/`.mn`, List.wz, newer KMST formats | PKG1 mainline; PKG2 header only; `.ms`/`.mn` directory tables and initial image payload extraction; no List.wz | ~45% | M5 |
