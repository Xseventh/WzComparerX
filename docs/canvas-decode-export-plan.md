...
`DXT3` (`1026`), `DXT5` (`2050`), `DXT1` (`4097`), and `RGBA32Float`
(`4100`) into BGRA8888 preview pixels. PNG export and broader Canvas format
...
`769` / `2` / `2304` / `2562` / `1026` / `2050` / `4097` Canvas values.
`4100` is also supported as a viewer conversion slice.
