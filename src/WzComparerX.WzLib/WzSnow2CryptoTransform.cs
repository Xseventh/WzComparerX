...
{
    internal class WzSnow2CryptoTransform : ICryptoTransform, IDisposable
    {
        public WzSnow2CryptoTransform(ReadOnlySpan<byte> key, ReadOnlySpan<byte> iv, bool encrypting)
        {
