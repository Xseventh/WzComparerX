...
public sealed class ResourceInspectionService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var diagnostics = options.IncludeDebugMetadata
            ? ResourceInspectionValueProjection.BuildDiagnostics(inspection.ObjectValue, name)
            : null;
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new ResourceInspectionNode(
            ...
            options.IncludeDebugMetadata
                ? ResourceInspectionValueProjection.BuildDiagnostics(property.Value, property.Path)
                : null,
            new ResourceInspectionIdentity(
    ...
    private static IReadOnlyList<ResourceInspectionMetadata> BuildImageRootMetadata(WzImageInspection inspection)
    {
        ...
        ResourceInspectionValueProjection.AddMetadata(metadata, inspection.ObjectValue);
        return metadata;
    }
        ...
        ResourceInspectionResolvedLinkTarget? resolvedLinkedTarget)
    {
        ...
        ResourceInspectionValueProjection.AddMetadata(metadata, property.Value);
        return metadata;
    }
